...
namespace TankWars
{
    public class DrawingPanel : Panel
    {
        ...
        private void PowerupDrawer2(object o, PaintEventArgs e)
        {
            Powerup p = o as Powerup;
            ...
            int height = 8;
            e.Graphics.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.AntiAlias;
            using (System.Drawing.SolidBrush redBrush = new System.Drawing.SolidBrush(System.Drawing.Color.Maroon))
            using (System.Drawing.SolidBrush yellowBrush = new System.Drawing.SolidBrush(System.Drawing.Color.Orchid))
            using (System.Drawing.SolidBrush blackBrush = new System.Drawing.SolidBrush(System.Drawing.Color.DarkSlateGray))
            {
                // Circles are drawn starting from the top-left corner.
                // So if we want the circle centered on the powerup's location, we have to offset it
                // by half its size to the left (-width/2) and up (-height/2)
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            lock (theWorld)
            {
                ...
                {
                    DrawObjectWithTransform(e, pow, pow.GetLocation().GetX(), pow.GetLocation().GetY(), 0, PowerupDrawer2);
                }
            }
